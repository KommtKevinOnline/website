        ...
        <v-card-text>
          ...
          <v-row v-else>
            <v-col cols="12" v-for="alert in alerts">
              ...
              >
                <v-card-actions>
                  <v-btn icon="mdi-pencil" variant="text" color="orange" @click="edit(alert)" />
                  <v-btn icon="mdi-delete" variant="text" color="red" @click="remove(alert.id)" :loading="removeLoading" />
                </v-card-actions>
              </v-card>
            </v-col>
          </v-row>
